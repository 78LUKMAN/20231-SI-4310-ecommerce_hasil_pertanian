          ...
          class o {
            ...
            render(t) {
              ...
              if (
                ...
                const a = e("select", { class: "dataTable-selector rounded-3" });
              ...
              if (s.searchable) {
                const t = `<div class='dataTable-search'><input class='dataTable-input rounded-3' placeholder='${s.labels.placeholder}' type='text'></div>`;
