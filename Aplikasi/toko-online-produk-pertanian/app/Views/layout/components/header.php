                ...
                <li class="menu-category">
                    ...
                    <div class="dropdown-panel">
                        ...
                        <ul class="dropdown-panel-list">
                            ...
                            <li class="panel-list-item">
                                <a href="#">
                                    <img src="<?php echo base_url() ?>assets/img/banner/banner-2-headphone.png"
                        ...
                        <ul class="dropdown-panel-list">
                            ...
                            <li class="panel-list-item">
                                <a href="#">
                                    <img src="<?php echo base_url() ?>assets/img/banner/banner-2-handphone.png"
                                        alt="Headphone Collection" width="250" height="119">
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="dropdown-panel-list">
                            ...
                            <li class="panel-list-item">
                                <a href="#">
                                    <img src="<?php echo base_url() ?>assets/img/banner/banner-2-watch.png"
                                        alt="Headphone Collection" width="250" height="119">
                                </a>
                            </li>
                        </ul>
